...
class SizePricingTest extends TestCase {
    ...
    public function test_sizes_are_priced_differently()
    {
        ...
        $r = $this->withToken(\App\Models\User::factory()->create(['role' => 'customer'])->createToken('test')->plainTextToken)->postJson('/api/v1/reservations', ['service_type'=>'dine_in','customer_name'=>'A',
    ...
    public function test_a_large_with_no_large_price_must_not_sell_for_nothing()
    {
        ...
        $this->withToken(\App\Models\User::factory()->create(['role' => 'customer'])->createToken('test')->plainTextToken)->postJson('/api/v1/reservations', ['service_type'=>'dine_in','customer_name'=>'A',
