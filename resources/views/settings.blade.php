...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box;margin:0;padding:0}body{height:100vh;overflow:hidden;background:var(--bg);color:var(--text);font-family:"DM Sans",sans-serif}h1,h2,h3{font-family:"Playfair Display",serif}.layout{display:flex;height:100vh}.sidebar{width:260px;background:#fff;border-right:1px solid var(--line);display:flex;flex-direction:column;flex-shrink:0}.sidebar-brand{padding:22px 18px;border-bottom:1px solid var(--line);display:flex;align-items:center;gap:13px}.crown-icon{width:46px;height:46px;border-radius:50%;overflow:hidden;border:2px solid rgba(22,199,106,.3);background:linear-gradient(135deg,#0c6f3f,#16c76a)}.crown-icon img{width:100%;height:100%;object-fit:cover}.sidebar-brand h2{font-size:14px;line-height:1.2;background:linear-gradient(135deg,#16a65f,#2f9e62);-webkit-background-clip:text;-webkit-text-fill-color:transparent}.tagline{font-size:10px;color:var(--muted);letter-spacing:.5px}.sidebar-nav{flex:1;padding:14px 10px}.nav-section-title{padding:12px 10px 7px;color:var(--muted);font-size:10px;font-weight:700;letter-spacing:1px;text-transform:uppercase}.nav-item{display:flex;align-items:center;gap:10px;min-height:40px;padding:0 12px;border-radius:10px;color:var(--muted);font-size:13px;font-weight:600;text-decoration:none}.nav-item:hover,.nav-item.active{background:rgba(22,199,106,.13);color:var(--green)}.content{flex:1;min-width:0;min-height:0;padding:18px 22px;overflow:hidden;display:flex;flex-direction:column}.top{display:flex;align-items:flex-end;justify-content:space-between;gap:16px;margin-bottom:12px;flex-shrink:0}.top h1{font-size:28px}.top p{color:var(--muted);margin-top:5px}.page-note{display:flex;gap:10px;align-items:flex-start;background:#fff;border:1px solid var(--line);border-radius:12px;padding:9px 13px;margin-bottom:10px;color:var(--muted);font-size:12px;line-height:1.45;flex-shrink:0}.page-note i{color:var(--green);font-size:18px;margin-top:2px}.grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;flex:1;min-height:0}.card{background:var(--card);border:1px solid var(--line);border-radius:14px;overflow:hidden;box-shadow:var(--shadow);display:flex;flex-direction:column;min-height:0}.card-head{padding:11px 14px;flex-shrink:0;border-bottom:1px solid var(--line);display:flex;align-items:center;justify-content:space-between;gap:12px}.title-wrap{display:flex;align-items:center;gap:12px}.pay-icon{width:34px;height:34px;border-radius:12px;background:rgba(22,199,106,.12);display:grid;place-items:center;color:var(--deep);font-size:18px}.card h3{font-size:15px}.status{display:inline-flex;align-items:center;gap:6px;border-radius:999px;padding:5px 10px;font-size:11px;font-weight:800}.status.ready{background:rgba(22,199,106,.13);color:#11884b}.status.missing{background:rgba(239,61,95,.1);color:var(--danger)}.card-body{padding:13px;flex:1;min-height:0;overflow:auto;scrollbar-width:none}.card-body::-webkit-scrollbar{display:none}.hint{color:var(--muted);font-size:11px;line-height:1.4;margin-bottom:10px}.preview-shell{display:flex;flex-direction:column;gap:10px;margin-bottom:11px}.preview{width:100%;max-width:132px;margin:0 auto;aspect-ratio:1;border-radius:14px;border:1px solid var(--line);background:var(--soft);display:grid;place-items:center;overflow:hidden;color:var(--muted);font-size:42px}.preview img{width:100%;height:100%;object-fit:contain;background:#fff}.meta{display:grid;gap:10px}.meta-item{background:var(--soft);border:1px solid var(--line);border-radius:9px;padding:7px 10px}.meta-item span{display:block;color:var(--muted);font-size:10px;text-transform:uppercase;font-weight:800;letter-spacing:.7px}.meta-item strong{display:block;margin-top:2px;font-size:11px}.card-body .btn,.card-body form .btn{width:100%;min-width:0}.upload-box{border:1px dashed var(--line);border-radius:11px;background:#fbfdfb;padding:11px}.field{margin-bottom:9px}.field label{display:block;color:var(--muted);font-size:11px;text-transform:uppercase;letter-spacing:.8px;font-weight:800;margin-bottom:7px}.field input,.field select{width:100%;border:1px solid var(--line);border-radius:10px;background:#fff;color:var(--text);padding:10px 12px;font:inherit}.btn{height:36px;font-size:12px;border:0;border-radius:10px;padding:0 15px;background:linear-gradient(135deg,var(--green),var(--deep));color:#fff;font-weight:800;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;gap:8px;min-width:150px}.alert{border:1px solid rgba(22,199,106,.35);background:rgba(22,199,106,.1);color:#15864d;border-radius:11px;padding:9px 12px;margin-bottom:10px;font-size:12px;flex-shrink:0}.error{border-color:rgba(239,61,95,.4);background:rgba(239,61,95,.1);color:var(--danger)}@media(max-width:1100px){.preview-shell{grid-template-columns:1fr}.preview{width:100%;max-width:260px}}@media(max-width:1250px),(max-height:640px){body{height:auto;overflow:auto}.layout{height:auto;min-height:100vh}.content{overflow:visible;display:block}.grid{grid-template-columns:repeat(2,minmax(0,1fr));min-height:0}.card,.card-body{overflow:visible}.preview{max-width:190px}}
