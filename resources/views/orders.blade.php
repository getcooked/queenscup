...
function buildSidebarNav(){
  ...
  if(isAdmin()){
    ...
    h+='<div class="nav-section"><div class="nav-section-title">System</div><a class="nav-item" href="{{ url('/reports') }}"><i class="fas fa-chart-bar"></i> Reports</a><a class="nav-item" href="{{ url('/activity') }}"><i class="fas fa-clock-rotate-left"></i> Activity</a><a class="nav-item" href="{{ url('/settings') }}"><i class="fas fa-gear"></i> Settings</a></div>';
  }else if(isCashier()){
