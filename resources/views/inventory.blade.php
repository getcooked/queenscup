            ...
            <table>
                ...
                @forelse ($items as $item)
                    <tr>
                        ...
                        <td>{{ $item->category ?: '-' }}</td>
                        <td>&#8369;{{ number_format($item->regular_price, 2) }} / &#8369;{{ number_format($item->large_price, 2) }}</td>
                        <td>{{ $item->stock }}</td>
                        <td>
