...
<div class="layout">
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            @if($staffUser->role === 'admin')
                <div class="nav-section"><div class="nav-section-title">Main</div><a class="nav-item {{ $pageKey === 'dashboard' ? 'active' : '' }}" href="{{ url('/dashboard') }}"><i class="fas fa-chart-pie"></i> Dashboard</a><a class="nav-item {{ $pageKey === 'pos' ? 'active' : '' }}" href="{{ route('cashier.portal') }}"><i class="fas fa-cash-register"></i> Cashier Portal</a></div>
            ...
            @else
                <div class="nav-section"><div class="nav-section-title">Counter</div><a class="nav-item active" href="{{ route('cashier.portal') }}"><i class="fas fa-cash-register"></i> Cashier Portal</a><a class="nav-item" href="{{ url('/orders') }}"><i class="fas fa-receipt"></i> Orders</a></div>
            @endif
    ...
    <main class="content">
        <div class="top">
            <div><h1>{{ $pageTitle }}</h1><p>Process customer purchases, handle payments, print receipts, and record each sale accurately.</p></div>
