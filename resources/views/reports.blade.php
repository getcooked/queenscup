...
<div class="layout">
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section"><div class="nav-section-title">System</div><a class="nav-item active" href="{{ url('/reports') }}"><i class="fas fa-chart-bar"></i> Reports</a><a class="nav-item" href="{{ url('/activity') }}"><i class="fas fa-clock-rotate-left"></i> Activity</a><a class="nav-item" href="{{ url('/settings') }}"><i class="fas fa-gear"></i> Settings</a></div>
